...
class SubQuery_Api(Base):
    __tablename__: str = "sub_query_api"
    ...
    current_page: Column = Column("current_page", String(), default=0)
    page: Column = Column("page", Integer(), default=None)
    url: Column = Column("url", String(), default=None)
    qpkey: Column = Column("qpkey", Integer(), default=None)
